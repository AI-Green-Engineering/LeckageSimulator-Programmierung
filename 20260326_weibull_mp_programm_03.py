...
# ------------------------------------------------------------
# 20260326 - Weibull MP Programm 3
# ------------------------------------------------------------
# Intervall: 3
...
steps_per_tick = [
    ...
    6, 7, 6, 7, 7, 7, 7, 7, 7, 8,
    7, 8, 8, 8, 8, 8, 8, 9, 9, 8,
    9, 9, 10, 9, 10, 9, 10, 10, 10, 11,
    10, 11, 11, 11, 11, 12, 11, 12, 12, 13,
    12, 13, 13, 13, 13, 14, 13, 14, 15, 14,
    15, 15, 15, 16, 15, 16, 17, 16, 17, 17,
]
...
try:
    ...
    for i, step_count in enumerate(steps_per_tick, start=1):
        if step_count > 0:
            ...
            print(
                f"Takt {i:03d}/150 | Öffne um {step_count:2d} Schritte | "
