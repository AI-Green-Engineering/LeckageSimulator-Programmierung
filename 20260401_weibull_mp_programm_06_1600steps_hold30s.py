...
# ------------------------------------------------------------
# 20260401 - Weibull MP Programm 6
# ------------------------------------------------------------
# Intervall: 6
# Obere Intervallgrenze: 49.887769 Mio. Zyklen
# Öffnungsdauer: 10.78 min
...
steps_per_tick = [
    ...
    7, 8, 8, 8, 8, 8, 8, 8, 8, 8,
    9, 8, 8, 9, 9, 8, 9, 9, 9, 8,
    9, 10, 9, 9, 9, 9, 10, 9, 10, 10,
    9, 10, 10, 10, 10, 10, 10, 10, 11, 10,
    11, 10, 11, 11, 10, 11, 11, 11, 12, 11,
    11, 12, 11, 12, 11, 12, 12, 12, 12, 12,
    12, 13, 12, 13, 12, 13, 13, 13, 13, 13,
    13, 14, 13,
]

assert len(steps_per_tick) == 323, "Es müssen genau 323 Takte sein."
...
try:
    ...
    for i, step_count in enumerate(steps_per_tick, start=1):
        if step_count > 0:
            ...
            print(f"Takt {i:03d}/323 | Öffne um {step_count:2d} Schritte | kumulativ offen: {opened_steps}")
        else:
            print(f"Takt {i:03d}/323 | keine Bewegung | kumulativ offen: {opened_steps}")
